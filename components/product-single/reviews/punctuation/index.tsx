...
export default function Punctuation({ votes, punctuation, countOpinions }: PunctuationType) {
  ...
  return (
    <section className="product-punctuation">
      ...
      <div className="punctuation-btn-wrapper">
        <button type="button" className="btn btn--rounded btn--yellow">Adicionar opções</button>
      </div>
    </section>
  );
};