            ...
            <form className="form" onSubmit={handleSubmit(onSubmit)}>
              <div className="form__input-row">
                ...
                {errors.email && errors.email.type === 'pattern' &&
                  <p className="message message--error">Por favor, insira um e-mail válido</p>
                }
              </div>
              ...
              <div className="form__info">
                ...
                <a href="/forgot-password" className="form__info__forgot-password">Esqueceu a senha?</a>
              </div>
              ...
              <p className="form__signup-link">Ainda não é membro? <a href="/register">Cadastre-se</a></p>
            </form>
          </div>
