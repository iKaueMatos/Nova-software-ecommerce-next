        ...
        <div className="container">
          ...
          <article style={{ backgroundImage: 'url(/images/featured-2.jpg)' }} className="featured-item featured-item-small-first">
            <div className="featured-item__content">
              ...
              <a href="#" className="btn btn--rounded">Mais detalhes</a>
            </div>
          </article>
          ...
          <article style={{ backgroundImage: 'url(/images/featured-3.jpg)' }} className="featured-item featured-item-small">
            <div className="featured-item__content">
              ...
              <a href="#" className="btn btn--rounded">VER TUDO</a>
            </div>
          </article>
        </div>
      </section>
          ...
          <ul className="shop-data-items">
            <li>
              ...
              <div className="data-item__content">
                <h4>Frete Grátis</h4>
                <p>Todas as compras acima de $199 são elegíveis para frete grátis via USPS First Class Mail.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                ...
                <p>Todos os pagamentos são processados instantaneamente por meio de um protocolo de pagamento seguro.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                ...
                <p>Se um item chegar danificado ou você mudar de ideia, pode devolvê-lo para obter um reembolso total.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                ...
                <p>Projetados para durar, cada um de nossos produtos foi fabricado com os melhores materiais.</p>
              </div>
            </li>
          </ul>
        </div>
